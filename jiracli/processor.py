...
class AddCommand(Command):
    def eval(self):
        ...
        if self.args.issue_type and not self.args.issue_type.lower() in set(list(self.jira.get_issue_types().keys())).union(set(list(self.jira.get_subtask_issue_types().keys()))):
            raise UsageError(
